...
u8 Usart3_Receive;
u8 mode_data_3[8];
u8 six_data_stop_3[3]={0X59,0X59,0X59};  //停止数据样本
u8 six_data_start_3[3]={0X58,0X58,0X58};  //启动数据样本
...
{	
    ...
    {	  
        ...
        mode_data_3[0]=uart_receive;
        if(mode_data_3[0]==six_data_start_3[0]			&&mode_data_3[1]==six_data_start_3[1]			&&mode_data_3[2]==six_data_start_3[2]			)
        {	
        	Flag_Stop=0;   //3击低速挡 小车关闭电机
        	mode_data_3[0]=0;	mode_data_3[1]=0;	mode_data_3[2]=0;	
        }
        if(mode_data_3[0]==six_data_stop_3[0]			&&mode_data_3[1]==six_data_stop_3[1]			&&mode_data_3[2]==six_data_stop_3[2]			)
        {	
        ...
        mode_data_3[2]=mode_data_3[1];
        mode_data_3[1]=mode_data_3[0];
    }  											 
} 
